...
// CODE HERE
function canWeDeliverTwo (arr) {
    if(arr.includes(85203)){
        console.log(`You're in our delivery zone!`)
    }
}
...
//CODE HERE
let newFamilyDeal = deals[1].desc.trim().replace('March', 'April')

console.log(newFamilyDeal)